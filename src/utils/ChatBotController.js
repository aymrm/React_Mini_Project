...
export default function botControll(text,navi,dispatch,speech,isLogin){     
    ...
    switch (currentURL){
        ...
        case 'https://web-react-mini-project-jvpb2alnvkso15.sel5.cloudtype.app/':
            return botMainControll(text,navi,dispatch,speech)
        case 'http://localhost:3000/login':
        case 'https://web-react-mini-project-jvpb2alnvkso15.sel5.cloudtype.app/login':
            return botLoginControll(text,navi,dispatch,speech)
        case 'http://localhost:3000/profile':
        case 'https://web-react-mini-project-jvpb2alnvkso15.sel5.cloudtype.app/profile':
